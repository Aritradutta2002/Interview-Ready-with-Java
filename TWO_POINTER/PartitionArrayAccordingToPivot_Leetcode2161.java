...
/*
*   Author  : Aritra Dutta
*   Created : Monday, 03.03.2025  09:53 am
*/
...
public class PartitionArrayAccordingToPivot_Leetcode2161 {
    ...
    public static int[] pivotArray(int[] nums, int pivot) {
        ...
        /* Fill the elements less than the Pivot */
        int index = 0;
        for(var ele : nums){
            if(ele < pivot){
                result[index++] = ele;
        ...
        /* Fill the number of pivot elements */
        for(int i = 0; i < pivotCount; i++){
            result[index++] = pivot;
        }

        /* Fill the elements greater than the pivot */
        for(var ele : nums){
            if(ele > pivot){
                result[index++] = ele;
            }
