package com.dsa.datastructures.advanced.segmenttree.basics;

/**
 * Segment Tree - Complete Template
 * FAANG Frequency: Medium (Google, Amazon)
 * 
 * Use Cases:
 * - Range sum/min/max queries with updates
 * - When both queries and updates are frequent
 * 
...
public class SegmentTreeTemplate {
    ...
    private void build(int[] arr, int node, int start, int end) {
        ...
        // Merge operation (can be sum, min, max, etc.)
    ...
    public static void main(String[] args) {
        ...
        SegmentTreeTemplate st = new SegmentTreeTemplate(arr);
